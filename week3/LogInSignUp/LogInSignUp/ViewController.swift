...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // make default as log in interface
    ...
    // Use selectedSegmentIndex to switch log in/ sign up interface
    // mainly enable/disable checkText and change background color
    ...
    // Use do-catch for error handling and pop out aler display
    func logIn() {
    ...
    // Use guard let statement for all error cases for sign up
